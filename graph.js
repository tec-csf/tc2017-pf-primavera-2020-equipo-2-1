...
//////////////////////CODIGOS DE LOS ALGORITMOS
//Hace falta meter la medición de tiempo (desde el .js), las complejidades (desde el .html) y el código del algorimto (desde cualquiera).
//Checa los ids correspondientes a cada cosa en el main.html
//Si le hace falta algo en el html para su algorimto deginme a mí. 
